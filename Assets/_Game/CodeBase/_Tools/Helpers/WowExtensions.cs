...
namespace CodeBase._Tools.Helpers
{
    public static class WowExtensions
    {
        ...
        /// <param name="self"></param>
        /// <returns></returns>
        public static int Sign(this ref float self) => self > 0 ? 1 : -1;
        ...
        /// <returns></returns>
        public static bool Contains(this ref LayerMask mask, int layer)
        {
        ...
        public static bool IsIntersection(this ref Vector3 pointPosition, Vector3 intersectionCenter, float borderX,
            float borderZ)
        {
        ...
        /// <returns></returns>
        public static bool IsEven(this ref int number) => number % 2 == 0;
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static string ToShortString(this ref int value)
        {
            ...
            if (thousandCount >= letterArray.Length)
